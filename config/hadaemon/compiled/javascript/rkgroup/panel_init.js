$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-logo-frame"] = new baseiframe("default-logo-frame", "", "rkgroup", {'widget_type': 'baseiframe', 'fields': {'title': '', 'frame_src': '', 'img_src': '', 'frame_style': '""'}, 'icons': [], 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'css': {}, 'static_icons': [], 'img_list': ['https://storage.googleapis.com/rkgroup/rk_logo.png']})
    
        widgets["default-weather"] = new baseweather("default-weather", "", "rkgroup", {'widget_type': 'baseweather', 'fields': {'title': '', 'unit': '', 'dark_sky_temperature': '', 'dark_sky_humidity': '', 'dark_sky_precip_probability': '', 'dark_sky_precip_intensity': '', 'dark_sky_wind_speed': '', 'dark_sky_pressure': '', 'dark_sky_wind_bearing': '', 'dark_sky_apparent_temperature': '', 'dark_sky_icon': ''}, 'css': {}, 'static_css': {'title_style': 'color: #f2f375;', 'unit_style': 'color: #ffaa00;', 'main_style': 'color: #ffaa00;', 'sub_style': 'color: #f2f375;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'icons': [], 'static_icons': [], 'units': '&deg;C'})
    
        widgets["default-clock"] = new baseclock("default-clock", "", "rkgroup", {'widget_type': 'baseclock', 'fields': {'date': '', 'time': ''}, 'static_css': {'date_style': 'color: #fff;', 'time_style': 'color: #FFF;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'static_icons': [], 'icons': [], 'css': {}, 'show_seconds': 1, 'time_style': 'color: #FFF;'})
    
        widgets["default-office-temp"] = new basedisplay("default-office-temp", "", "rkgroup", {'widget_type': 'basedisplay', 'entity': 'sensor.office_temperature', 'sub_entity': '', 'fields': {'title': 'ห้องออฟฟิต', 'title2': '', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'title2_style': 'color: #fff;font-weight: 400;', 'unit_style': 'color: #FFF;', 'value_style': 'color: #FFF;', 'state_text_style': '', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'css': {'value_style': 'color: #FFF;', 'text_style': 'color: #fff;', 'unit_style': 'color: #FFF;'}, 'icons': [], 'static_icons': [], 'units': '&deg;C', 'value_style': 'color: #FFF;', 'unit_style': 'color: #FFF;'})
    
        widgets["default-reload"] = new javascript("default-reload", "", "rkgroup", {'widget_type': 'javascript', 'command': 'location.reload(true)', 'fields': {'title': 'รีเฟรส', 'title2': '', 'icon': '', 'icon_style': ''}, 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-refresh'}, 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'title2_style': 'color: #fff;font-weight: 400;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'css': {'icon_active_style': 'color: #fff;', 'icon_inactive_style': 'color: #fff;'}, 'static_icons': []})
    
        widgets["default-left-lamp"] = new baseswitch("default-left-lamp", "", "rkgroup", {'widget_type': 'baseswitch', 'entity': 'light.left_lamp', 'state_active': 'on', 'state_inactive': 'off', 'enable': 1, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'light.left_lamp'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'light.left_lamp'}, 'fields': {'title': 'ไฟด้านซ้าย', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'fa-lightbulb-o', 'icon_off': 'fa-lightbulb-o'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #ffaa00;', 'icon_style_inactive': 'color: antiquewhite;'}, 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'title2_style': 'color: #fff;font-weight: 400;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'icon_on': 'fa-lightbulb-o', 'icon_off': 'fa-lightbulb-o'})
    
        widgets["default-center-lamp"] = new baseswitch("default-center-lamp", "", "rkgroup", {'widget_type': 'baseswitch', 'entity': 'switch.center_lamp', 'state_active': 'on', 'state_inactive': 'off', 'enable': 1, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'switch.center_lamp'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'switch.center_lamp'}, 'fields': {'title': 'ไฟตรงกลาง', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'fa-lightbulb-o', 'icon_off': 'fa-lightbulb-o'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #ffaa00;', 'icon_style_inactive': 'color: antiquewhite;'}, 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'title2_style': 'color: #fff;font-weight: 400;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'icon_on': 'fa-lightbulb-o', 'icon_off': 'fa-lightbulb-o'})
    
        widgets["default-right-lamp"] = new baseswitch("default-right-lamp", "", "rkgroup", {'widget_type': 'baseswitch', 'entity': 'switch.right_lamp', 'state_active': 'on', 'state_inactive': 'off', 'enable': 1, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'switch.right_lamp'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'switch.right_lamp'}, 'fields': {'title': 'ไฟด้านขวา', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'fa-lightbulb-o', 'icon_off': 'fa-lightbulb-o'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #ffaa00;', 'icon_style_inactive': 'color: antiquewhite;'}, 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'title2_style': 'color: #fff;font-weight: 400;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'icon_on': 'fa-lightbulb-o', 'icon_off': 'fa-lightbulb-o'})
    
        widgets["default-door-sensor"] = new basedisplay("default-door-sensor", "", "rkgroup", {'widget_type': 'basedisplay', 'entity': 'binary_sensor.door_sensor', 'sub_entity': '', 'fields': {'title': 'ประตูออฟฟิต', 'title2': '', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'color: #fff;font-weight: 400;', 'title2_style': 'color: #fff;font-weight: 400;', 'unit_style': '', 'value_style': '', 'state_text_style': '', 'widget_style': 'background-color: rgba(0,0,0,0.4);'}, 'css': {'value_style': '', 'text_style': 'color: #fff;', 'unit_style': ''}, 'icons': [], 'static_icons': [], 'state_map': {'on': 'เปิด', 'off': 'ปิด'}})
